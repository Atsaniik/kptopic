...
def netKPT(edgesDF:pd.DataFrame,col1 = 'node1',col2 = 'node2',col1a ='node1a',col2a='node2a',
            ...
            commMethod='louvain' ,louvain_resolution=1,
    ...
    Args:
        ...
        method= commMethod: community generated by 'k-clique' or 'louvain'
        louvain_resolution: louvain method resolution
    ...
    topicDFcomm,topicDFnoun = communKPT(G, method= commMethod,louvain_resolution=louvain_resolution,min_weight=minWeightTopic, k_clique = kCliqueCOMMtopic,topicN = topicBYnoun , maxNOUNtopic=maxNOUNtopic)
    if visualizeNET:
        sentiments2 = []
